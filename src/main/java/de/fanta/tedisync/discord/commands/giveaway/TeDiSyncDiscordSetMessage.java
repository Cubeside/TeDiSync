...
public class TeDiSyncDiscordSetMessage extends SubCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String alias, String commandString, ArgsParser args) {
        ...
        if (!args.hasNext()) {
            ChatUtil.sendErrorMessage(player, "Du musst eine Nachricht für das Gewinnspiel angeben.");
            return true;
        }

        giveaway.setMessage(args.getAll(null));
        ChatUtil.sendNormalMessage(player, "Du hast eine Nachricht für das Gewinnspiel hinzugefügt.");
        return true;
    }
