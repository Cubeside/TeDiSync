...
public class TeDiSyncDiscordDelete extends SubCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String alias, String commandString, ArgsParser args) {
        ...
        if (giveaway.delete()) {
            ChatUtil.sendNormalMessage(player, "Das Gewinnspiel " + ChatUtil.BLUE + giveawayName + ChatUtil.GREEN + " wurde gelöscht.");
            DiscordBot.getUserEditGiveaway().remove(player.getUniqueId());
        } else {
            ChatUtil.sendNormalMessage(player, "Das Gewinnspiel " + ChatUtil.BLUE + giveawayName + ChatUtil.GREEN + " konnte nicht gelöscht werden.");
        }
